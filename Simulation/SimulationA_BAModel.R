...
#simulation scenario A in the paper
...
#lst_mod_test<-MultiModuleFind_cos(network.test,node.scores,edge.scores,ncluster=4)
...
result11.sim11<-list(lst.nodenum.c,lst.id.clusters)
save(result11.sim11,file=paste(out_dir,"BAnew_clustersize",as.character(n.size),"_power",as.character(power*10),"m",as.character(77),".Rdata",sep=""))
...
result11.sim12<-list(lst.nodenum.c,lst.id.clusters)
save(result11.sim12,file=paste(out_dir,"BAnew_clustersize",as.character(n.size),"_power",as.character(power*10),"m",as.character(24),".Rdata",sep=""))
...
result1.sim21<-list(lst.nodenum.c,lst.id.clusters)
...
result1.sim22<-list(lst.nodenum.c,lst.id.clusters)
